...
import { UpdateProfileRequest } from '../../../features/account/account.interface';
...
export class EditForm {
  ...
  cancelRoute = input<string | null>('/account/profile'); // valeur par défaut = comportement actuel
  cancel = output<void>();
